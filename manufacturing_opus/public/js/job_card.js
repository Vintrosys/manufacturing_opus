    ...
    complete_job_card(frm) {
		...
		frm.job_completion_dialog = frappe.prompt(
			...
			(data) => {
                ...
                frappe.call({
                    method: 'manufacturing_opus.overrides.job_card.make_time_log',
                    args: {
                        args: {
...
frappe.ui.form.on('Job Card', {
    open_rm_selection_popup(frm) {
        frappe.call({
            method: 'manufacturing_opus.overrides.job_card.get_mtfm_items',
            ...
            const d = new frappe.ui.Dialog({
                ...
                primary_action(values) {
                    ...
                    frappe.call({
                        method: 'manufacturing_opus.overrides.job_card.create_material_transfer',
                        args: {
